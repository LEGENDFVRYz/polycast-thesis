...
class OnlineTrailSmoother:
    ...
    # Short 3-point causal kernel.  This reduces jitter but avoids the
    # long lag/rounding introduced by a 5- or 7-point average.  Keeping the
    # buffer short preserves small handwriting features better.
    _WEIGHTS = np.array([0.20, 0.30, 0.50])
