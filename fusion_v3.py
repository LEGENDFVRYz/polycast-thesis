...
def process_imu_sample(qx, qy, qz, qw, ax_s, ay_s, az_s, t_us):
    ...
    # BNO085 linear acceleration (already gravity-free)
    ...
    # ======================================================
    # 1. REMOVE ROTATION + GRAVITY HANDLING
    # (since accel is already linear acceleration)
    # ======================================================
    # ❌ Removed:
    r = R.from_quat([qx, qy, qz, qw])
    accel_world = r.apply(accel_local)
    accel_world[1] *= -1
    # ax_aligned, ay_aligned = rotate_vec2d(...)
    # accel_world = ...
    #
    # ✔ Now use accel_local directly
    # ======================================================

    # accel_world = accel_local.copy()  # treat linear accel as world-frame accel

    # ======================================================
    # 2. REMOVE GRAVITY CALIBRATION
    # ======================================================
    # if is_calibrating:
    #     # IMMEDIATELY FINISH CALIBRATION because linear accel needs none
    #     is_calibrating = False
    #     gravity_ref[:] = 0   # No gravity to remove
    #     print("--- Calibration skipped (linear accel detected) ---")
    #     return True

    # ======================================================
    # 3. REMOVE GRAVITY SUBTRACTION
    # ======================================================
    # ❌ Removed: accel_world -= gravity_ref

    # ======================================================
    # 4. REMOVE GRAVITY-BASED NOISE FLOORING
    # ======================================================
    # ❌ Removed:
    ...
    info_label.setText(
        ...
        f"Pos X: {fused_pos[0]:.3f} | Y: {fused_pos[2]:.3f}\n"
