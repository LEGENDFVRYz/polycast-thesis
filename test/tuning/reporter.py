...
def plot_trajectory_comparison(
    ...
    for ax, results, label, color in [
        ...
        # Board outline
        ax.add_patch(
            plt.Rectangle((0, 0), board_w, board_h,
        ...
        stroke_patch = mpatches.Patch(color=color, label='Stroke (contact)')
        air_patch    = mpatches.Patch(color='gray', alpha=0.4, label='Air movement')
